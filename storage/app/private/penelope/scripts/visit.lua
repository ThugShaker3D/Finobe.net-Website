...
pcall(function() game:GetService("Players"):SetBuildUserPermissionsUrl("http://www.finobe.net/game/BuildActionPermissionCheck.ashx?assetId=0&userId=%d&isSolo=true") end)
...
if success then
	...
	if not inStudio then
		if false then
			game:HttpPost("https://data.finobe.net/Error/Lua.ashx", "Visit.lua: " .. err)
		end
	end
end

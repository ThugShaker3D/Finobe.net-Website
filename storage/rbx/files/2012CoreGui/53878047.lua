...
CLBackground.Image = "http://www.finobe.net/asset/?id=96536002"
...
BackgroundUp.Image = 'http://www.finobe.net/asset/?id=97662207'
...
BackpackButton.Image = "http://www.finobe.net/asset/?id=97617958"
...
TempSlot.ZIndex = 3.0
	...
	slotBackground.Image = 'http://www.finobe.net/asset/?id=97613075'
	...
	HighLight.Image = 'http://www.finobe.net/asset/?id=97643886'
...
Backpack.Active = true
	...
	Tabs.Parent = Backpack
		...
		closeButton.Modal = true
			...
			XImage.Name = "XImage"
			game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=75547445")
			XImage.Image = "http://www.finobe.net/asset/?id=75547445"  --TODO: move to rbxasset
	...
	Wardrobe.Parent = Backpack
		...
		CharacterPane.Parent = Wardrobe
			...
			local FaceFrame = makeCharFrame("FacesFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=75460621")
				makeZone("FaceZone","http://www.finobe.net/asset/?id=75460621",UDim2.new(0,157,0,137),UDim2.new(0.5,-78,0.5,-68),FaceFrame)
			...
			local HeadFrame = makeCharFrame("HeadsFrame", CharacterPane)
				makeZone("FaceZone","http://www.finobe.net/asset/?id=75460621",UDim2.new(0,157,0,137),UDim2.new(0.5,-78,0.5,-68),HeadFrame)
			...
			local HatsFrame = makeCharFrame("HatsFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=75457888")
				local HatsZone = makeZone("HatsZone","http://www.finobe.net/asset/?id=75457888",UDim2.new(0,186,0,184),UDim2.new(0.5,-93,0.5,-100), HatsFrame)
			...
			local PantsFrame = makeCharFrame("PantsFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=75457920")
				makeZone("PantsZone","http://www.finobe.net/asset/?id=75457920",UDim2.new(0,121,0,99),UDim2.new(0.5,-60,0.5,-100),PantsFrame)
			...
			local TShirtFrame = makeCharFrame("T-ShirtsFrame",CharacterPane)
				game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=75460642")
				makeZone("TShirtZone","http://www.finobe.net/asset/?id=75460642",UDim2.new(0,121,0,154),UDim2.new(0.5,-60,0.5,-100),TShirtFrame)
			...
			local ShirtFrame = makeCharFrame("ShirtsFrame", CharacterPane)
				makeZone("ShirtZone","http://www.finobe.net/asset/?id=75460642",UDim2.new(0,121,0,154),UDim2.new(0.5,-60,0.5,-100),ShirtFrame)
			...
			local ColorFrame = makeCharFrame("ColorFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://www.finobe.net/asset/?id=76049888")
				local ColorZone = makeZone("ColorZone","http://www.finobe.net/asset/?id=76049888", UDim2.new(0,120,0,150),UDim2.new(0.5,-60,0.5,-100),ColorFrame)

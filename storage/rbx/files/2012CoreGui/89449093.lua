...
function showBackpack()
	...
	delay(guiTweenSpeed,function()
		...
		canToggle = true
		readyForNextEvent = true
		backpackButton.Image = 'http://www.finobe.net/asset/?id=97644093'
...
function toggleBackpack()	
	...
	if backpackIsOpen then				
		loadoutBackground.Image = 'http://www.finobe.net/asset/?id=97623721'
		...
		loadoutBackground.Image = 'http://www.finobe.net/asset/?id=96536002'
